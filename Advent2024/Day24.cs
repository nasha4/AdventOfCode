...
public partial class Day24(InputHelper inputHelper) : IAdventPuzzle
{
    ...
    public long Solve(bool isPart1)
    {
        ...
        return gates.Where(g => g.Key.StartsWith('z')).OrderBy(z => z.Key).Select((z, i) => Calc(z.Key) ? 1L << i : 0).Sum();
    }
