...
public class Day06(InputHelper inputHelper) : IAdventPuzzle
{
    private readonly Cartesian<int>.GridHelper grid = new(inputHelper.EachLine(line => line));
