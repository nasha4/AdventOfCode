...
public partial class Day21(InputHelper inputHelper) : IAdventPuzzle
{
    private class RobotArm(Cartesian<int>.GridHelper grid, Func<IReadOnlyDictionary<(char, char), long>, IReadOnlyDictionary<(char, char), long>>? presequencer = null)
    {
        private class Orderer(string order) : IComparer<char>
        {
