...
The first thing I looked at on this puzzle is the size of the numeric ranges; they are small enough (10⁶–10⁷) that it is quite reasonable to do a brute force search.

I didn't do that!  I did it a computationally faster, developmentally harder way: I generate all the repsequences within each range, and sum those.  The only hard
part is when a range straddles a power of ten, like 899–1122.  We want to find 999 but also 1010 and 1111 and not 909.  (Also, make sure to count 1111 only once!)
